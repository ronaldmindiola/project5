...
export function SignupForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="w-full max-w-sm mx-auto bg-background border border-border rounded-lg shadow-lg">
              ...
              <div className="grid gap-2">
                ...
                <div className="grid gap-2">
                  <div className="flex items-center">
                    <Label className="hidden" htmlFor="password">Contraseña</Label>
                  </div>
                  <Input
                    id="password"
                    type="password"
                  ...
                  />
                  <div className="flex items-center">
                    <Label className="hidden" htmlFor="password">Confirmar contraseña</Label>
                  </div>
                  <Input
                    id="password"
                    type="password"
